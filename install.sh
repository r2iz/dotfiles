...
packages=(greetd greetd-regreet hyprland hyprpaper waybar wofi wlogout swaylock swayidle grim slurp swappy brightnessctl wl-clipboard mako xdg-desktop-portal-hyprland xdg-desktop-portal-gtk polkit-gnome qt5-wayland qt6-wayland adwaita-icon-theme alacritty fish starship ttf-jetbrains-mono-nerd noto-fonts-emoji fcitx5 fcitx5-gtk fcitx5-qt fcitx5-mozc-ut fcitx5-configtool neovim git curl)
